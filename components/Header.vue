        ...
        >
          ...
          >
            <li>
              <NuxtLink
                to="/"
                class="block py-2 pr-4 pl-3 text-white rounded bg-blue-700 lg:bg-transparent lg:text-gray-700 lg:hover:text-blue-700 lg:p-0 dark:text-white"
                >Home</NuxtLink
              >
            </li>
            <li>
            ...
            <li>
              <NuxtLink
                to="/statamic"
                class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                >Statamic Blog</NuxtLink
              >
            </li>
            <li>
              <a
                href="https://github.com/nperegrine/nuxt-cms-demo-app"
                target="_blank"
                class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                >Source code</a
              >
